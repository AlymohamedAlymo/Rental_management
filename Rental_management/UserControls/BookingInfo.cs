...
namespace CustomControls
{
    public partial class BookingInfo : UserControl
    {
        ...
        public BookingInfo()
        {
            ...
            this.closeButton.Image = Rental_management.Properties.Resources.not_clean;
            
            this.bookingNameLabel.Image = Rental_management.Properties.Resources.edit;
        ...
        internal void LoadBookingInfo(Booking booking, BindingList<Room> rooms)
        {
            ...
            if (this.bookingDatesGrid.Columns.Count == 0)
            {
                ...
                {
                    c.HeaderImage = Rental_management.Properties.Resources.GlyphCalendar_small;
        ...
        private void bookingDatesGrid_Click(object sender, EventArgs e)
        {
